...
### Fixed
- Fixed empty page issue - React app was not rendering because `renderApp()` was never called
- Updated deprecated dependencies from Create React App to Vite
- Fixed file extensions (.jsx) for JSX-containing files

### Changed
- Migrated from react-scripts (Create React App) to Vite for modern build tooling
- Updated all dependencies to latest stable versions:
  ...
  - vite: ^6.0.7
  - vitest: ^3.0.0
- Changed build output directory from `build` to `dist` (Vite default)
- Renamed server.js to server.cjs (CommonJS for Node.js)

### Added
- Added comprehensive test coverage with Vitest
- Added tests for Header, useTheme hook, HomeAssistant service
- Added ESLint flat config (eslint.config.mjs)
- Added Vitest setup file
- Added Vite configuration for testing and coverage

### Security
- No vulnerabilities found in dependencies (0 vulnerabilities)
